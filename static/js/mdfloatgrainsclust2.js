/*
  ...
  MD simulation of floating grains clustering with falling ball
	Sparisoma Viridi | dudung@gmail.com
  Rizal Kurniadi | rijalk@itb.ac.id
  
  20240828
  0730 Start adapt for Hugo post on bug from remah.
...
function createVisualElements(cid) {
  ...
  mainDiv = document.getElementById(cid);
  
	mainDiv.append(dvLeft);
		dvLeft.append(taIn);
